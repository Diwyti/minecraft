...
execute in minecraft:in_the_fog unless entity @e[tag=portal_ot] align xz positioned over motion_blocking_no_leaves run summon area_effect_cloud 0 ~ 0 {Duration:999999999,Invisible:1b,Tags:["portal_ot"]}
